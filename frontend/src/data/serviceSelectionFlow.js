...
const textRequirementLabels = new Set(['Mobile number', 'Email ID', 'Mobile number and email ID'])

export function getRequiredDocumentInputType(requiredDocument) {
  return textRequirementLabels.has(requiredDocument) ? 'text' : 'file'
}
