...
export const testimonials = [
  {
    ...
    company: 'D2C Founder',
    quote:
      'They streamlined our GST and bookkeeping workflows in under a month, and now our reporting is finally predictable.',
  },
  {
    name: 'Kunal Sethi',
    company: 'Consulting Professional',
    quote:
      'My tax filing and compliance questions get answered quickly, clearly, and without jargon. It feels like having an in-house advisor.',
  },
  {
    name: 'Ananya Sharma',
    company: 'Early-stage Startup',
    quote:
      'From incorporation to our first audit, the team kept every milestone organized and easy to track through the client dashboard.',
  },
]
...
export const dashboardLinks = [
  ...
  { label: 'Prepared Documents', to: '/dashboard/prepared-documents' },
...
export const adminLinks = [
  ...
  { label: 'Inquiries', to: '/admin/inquiries', icon: 'phone' },
  { label: 'Users Folder', to: '/admin/folders', icon: 'folder' },
