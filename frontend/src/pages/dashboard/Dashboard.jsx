      ...
      ...sortByLatest(summary.documents).slice(0, 2).map((document) => ({
        ...
        title:
          document.inputType === 'text'
            ? document.title || 'Text details submitted'
            : document.originalName || document.filename || 'Document uploaded',
        ...
        preview: buildPreviewPayload({
          ...
          fileName: document.inputType === 'text' ? '' : document.originalName || document.filename,
